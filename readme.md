...
``` bash
go get github.com/liusining/bitfinex-api-go
```
...
import (
	"fmt"
	"github.com/liusining/bitfinex-api-go/v1"
)
...
See [examples](https://github.com/liusining/bitfinex-api-go/tree/master/examples) and [doc.go](https://github.com/liusining/bitfinex-api-go/blob/master/doc.go) for more examples.
...
1. Fork it (https://github.com/liusining/bitfinex-api-go/fork)
